...
const Galery =(props) =>{
    const {imgs=[], imgsSmall=[],isOpenModal=false, openModal=null,closeModal=null} = {...props}
    ...
    return(
        <div {...props} >
            ...
            <div className="col-span-4 relative  ">
                ...
                <img loading="lazy" onClick={openModal} src={imgs[image]} alt="" className="aspect[16/13] xl:aspect[16/16] xl:max-h-86 2xl:max-h-96 2xl:aspect[16/18] w-full md:[16/19] md:rounded-md object-cover"/>
            ...
            {imgsSmall.map((small,i)=>{
                return(
                    <div onClick={()=>{setImage(i)}} key={i} className="relative md:rounded-md overflow-hidden ">
                        <img  loading="lazy" src={small} alt="" className="hidden md:block "/>
                        <span className={`absolute rounded-md h-full w-full  top-0 hover:border-2  hover:border-gray-primary hover:bg-[rgba(255,255,255,0.5)] 
