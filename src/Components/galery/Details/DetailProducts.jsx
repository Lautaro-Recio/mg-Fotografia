...
const DetailProducts =() =>{
    ...
    return(
                ...
                <div className="container mx-auto px-4 md:w-full  ">
                    <p className="font-bold mt-[25%] text-gray-primary mb-4 uppercase tracking-wide">Sneaker Company</p>
                    ...
                    <div className="grid gap-4 grid-cols-3 font-bold items-center justify-center mb-5 md:w-auto ">
                        ...
                        <span className="text-gray-primary bg-pale-orange rounded-md mr-auto p-1 "> 50%</span>
                    ...
                    <div className="grid md:flex mb-10 md:w-auto md:gap-5 ">
                        <div className="grid grid-cols-3 items-center font-bold mb-4  justify-center text-center bg-gray-100 rounded-md w-full md:w-50 md:mb-0">
                            <button className="text-gray-primary  text-4xl" onClick={subtract}>-</button>
                            <span>{amount}</span>
                            <button className="text-gray-primary text-4xl" onClick={add} >+</button>
                        </div>
                        <button className="flex mx-auto gap-4 justify-center text-white rounded-md py-3 bg-gray-primary w-full md:w-50 hover:bg-orange-400">
