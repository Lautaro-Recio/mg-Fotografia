...
export default function Modal(props) {
  const { bookOfModal, closeModal, nameOfBook, ImgOfModal } = { ...props };
  ...
  return (
    <div className="absolute w-full flex h-screen p-0  top-0 z-40 overflow-scroll">
      <div>
        <button
          onClick={closeModal}
          className="z-20 text-2xl top-4 left-8 text-transparent-gray absolute   "
        >
          X
        </button>
        {gallery && (
          <>
            <button
              ...
              className="z-20 text-2xl top-12 left-7 text-transparent-gray absolute   "
            >
              ←
            </button>
            <p className="z-20 text-xl top-8 right-7 text-transparent-gray absolute   ">
